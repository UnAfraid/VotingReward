 ...
 */
package com.github.unafraid.votingreward.l2ro;
...
import l2ro.gameserver.handler.voicecommands.VoicedCommandHandler;

/**
 * @author UnAfraid
 */
public class L2ROInterface implements IVotingRewardInterface
{
	private static final Logger LOG = LoggerFactory.getLogger(L2ROInterface.class);
	...
	{
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new L2ROVoicedHandler(handler));
