 ...
 * @author UnAfraid
 */
public class L2ROVoicedHandler implements IVoicedCommandHandler
{
	private final IOnVoicedCommandHandler _handler;
	
	public L2ROVoicedHandler(IOnVoicedCommandHandler handler)
	{
		_handler = handler;
	}
	...
	{
		return _handler.useVoicedCommand(command, new L2ROPlayer(activeChar), params);
	}
