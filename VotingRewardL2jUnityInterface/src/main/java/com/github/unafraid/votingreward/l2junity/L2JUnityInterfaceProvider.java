 ...
 * @author UnAfraid
 */
public class L2JUnityInterfaceProvider implements IVotingRewardInterfaceProvider
{
	private static final IVotingRewardInterface INTERFACE = new L2JUnityInterface();
