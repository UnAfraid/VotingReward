 ...
 * @author UnAfraid
 */
public class ServerVotingResultData implements IVotingObject
{
	...
	public ServerVotingResultData(JSONObject jsonObject)
	{
		_totalVotes = jsonObject.getInt(TOTAL_VOTES_FIELD);
	}
