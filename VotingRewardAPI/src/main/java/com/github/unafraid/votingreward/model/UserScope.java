...
public enum UserScope
{
	...
	{
		@Override
		public String getData(IPlayerInstance player)
		{
	...
	HWID
	{
		...
		@Override
		public boolean isSupported(IPlayerInstance player)
		{
			return player.isHWIDSupported();
		}
	};
	
	public abstract String getData(IPlayerInstance player);
